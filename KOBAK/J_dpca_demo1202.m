c%% This section creates toy data.
%
...
[firingRates,~,~,~,] = dimRed(AVG1,AVG2,AVG3,indDel1,FR1_red);
%trialNum:
...
time = [0:0.02:1.16];
%timeEvents = 1000;
timeEvents = time(round(length(time)/2)); %30.
...
dpca_perMarginalization(firingRatesAverage, @dpca_plot_default, ...
   'combinedParams', combinedParams, 'time', time);
